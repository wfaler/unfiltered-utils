...
object UnfilteredUtils extends Build {
  ...
  object Dependencies {
    ...
    val unfiltered = "net.databinder" %% "unfiltered-filter" % "0.6.8"
  ...
  lazy val sitegen = Project("unfiltered-utils", file("."),
    ...
    .settings(libraryDependencies := Seq(scalate,scalaCompiler,scalaLang,unfiltered,liftJson,scalaz,jodaTime, specs2),
